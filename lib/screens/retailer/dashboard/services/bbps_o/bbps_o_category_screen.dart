...
class BbpsOCategoryScreen extends StatefulWidget {
  const BbpsOCategoryScreen({super.key});

  @override
  State<BbpsOCategoryScreen> createState() => _BbpsOCategoryScreenState();
}

class _BbpsOCategoryScreenState extends State<BbpsOCategoryScreen> {
  ...
  Future<void> callAsyncApi() async {
    try {
      await bbpsOController.getBbpsCategoryList();
      searchedList.assignAll(bbpsOController.bbpsCategoryList);
    } catch (e) {
  ...
  searchFromList(String value) async {
    ...
    if (value.isEmpty) {
      ...
      List<BbpsCategoryListModel> tempList = bbpsOController.bbpsCategoryList.where((element) {
  ...
  @override
  void dispose() {
    bbpsOController.bbpsCategoryList.clear();
    bbpsOController.bbpsSearchCategoryController.clear();
    super.dispose();
  }
          ...
          SizedBox(
            ...
            child: Card(
              ...
              child: CustomTextField(
                controller: bbpsOController.bbpsSearchCategoryController,
                style: TextHelper.size14.copyWith(
              ...
              child: searchedList.isEmpty
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        BbpsCategoryListModel bbpsOCategoryData = searchedList[index];
                        return Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            GestureDetector(
                              onTap: () async {
                                ...
                                await Get.toNamed(
                                  Routes.BBPS_O_SUB_CATEGORY_SCREEN,
                                  arguments: bbpsOCategoryData,
                                );
                                bbpsOController.bbpsSearchCategoryController.clear();
                                searchedList.assignAll(bbpsOController.bbpsCategoryList);
                              },
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: ShowNetworkImage(
                                        networkUrl: bbpsOCategoryData.fileUrl != null && bbpsOCategoryData.fileUrl!.isNotEmpty ? bbpsOCategoryData.fileUrl! : '-',
                                    ...
                                    Flexible(
                                      child: Text(
                                        bbpsOCategoryData.name != null && bbpsOCategoryData.name!.isNotEmpty ? bbpsOCategoryData.name! : '-',
                                        style: TextHelper.size14.copyWith(
                                          fontFamily: mediumGoogleSansFont,
                                        ),
                                      ),
