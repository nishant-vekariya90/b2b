...
class _PostpaidRechargeScreenState extends State<PostpaidRechargeScreen> {
  ...
  final Rx<GlobalKey<FormState>> postpaidRechargeFormKey = GlobalKey<FormState>().obs;
  ...
  Future<void> callAsyncApi() async {
    try {
      ...
      await rechargeController.getMasterOperatorList(operator: 'postpaid', isLoaderShow: false);
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  height(0.5.h),
                  Text(
                    'Postpaid recharge for leading mobile service providers with just couple of clicks.',
                    maxLines: 3,
      ...
      mainBody: SingleChildScrollView(
        ...
        child: Obx(
          () => Form(
            key: postpaidRechargeFormKey.value,
            child: Column(
              ...
              children: [
                ...
                CustomTextFieldWithTitle(
                  ...
                  title: 'Postpaid number',
                  hintText: 'Enter postpaid number',
                  maxLength: 10,
                  isCompulsory: true,
                  ...
                  validator: (value) {
                    if (rechargeController.mobileNumberController.text.trim().isEmpty) {
                      return 'Please enter postpaid number';
                    } else if (rechargeController.mobileNumberController.text.length < 10) {
                      return 'Please enter valid postpaid number';
                    }
                    return null;
                  },
                ),
                ...
                CommonButton(
                  label: 'Proceed',
                  onPressed: () async {
                    if (postpaidRechargeFormKey.value.currentState!.validate()) {
  ...
  Future<dynamic> confirmationBottomSheet() {
    return customBottomSheet(
      ...
      onTap: () async {
        ...
        postpaidRechargeFormKey.value = GlobalKey<FormState>();
      },
    );
  }
}
