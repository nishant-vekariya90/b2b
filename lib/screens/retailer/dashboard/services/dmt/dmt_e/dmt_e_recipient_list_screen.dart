...
class DmtERecipientListScreen extends StatefulWidget {
  const DmtERecipientListScreen({Key? key}) : super(key: key);

  @override
  State<DmtERecipientListScreen> createState() => _DmtERecipientListScreenState();
}

class _DmtERecipientListScreenState extends State<DmtERecipientListScreen> {
  ...
  Future<void> callAsyncApi() async {
    try {
      await dmtEController.getRecipientList();
      ...
      child: CustomScaffold(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    width(1.w),
                    Text(
                      dmtEController.validateRemitterModel.value.data!.name != null && dmtEController.validateRemitterModel.value.data!.name!.isNotEmpty ? dmtEController.validateRemitterModel.value.data!.name! : '-',
                      style: TextHelper.size13.copyWith(
                ...
                Row(
                  children: [
                    ...
                    width(1.w),
                    Text(
                      dmtEController.validateRemitterModel.value.data!.mobileNo != null && dmtEController.validateRemitterModel.value.data!.mobileNo!.isNotEmpty ? dmtEController.validateRemitterModel.value.data!.mobileNo! : '-',
                      style: TextHelper.size13.copyWith(
                        fontFamily: boldGoogleSansFont,
                        color: ColorsForApp.primaryColor,
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            height(0.5.h),
                            Text(
                              dmtEController.validateRemitterModel.value.data!.bank1Limit != null && dmtEController.validateRemitterModel.value.data!.bank1Limit!.isNotEmpty
                                  ? '₹ ${dmtEController.validateRemitterModel.value.data!.bank1Limit!.toString()}'
                                  : '₹ 0.0',
                              maxLines: 2,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            height(0.5.h),
                            Text(
                              dmtEController.validateRemitterModel.value.data!.bank2Limit != null && dmtEController.validateRemitterModel.value.data!.bank2Limit!.isNotEmpty
                                  ? '₹ ${dmtEController.validateRemitterModel.value.data!.bank2Limit!.toString()}'
                                  : '₹ 0.0',
                              maxLines: 2,
                              style: TextHelper.size14.copyWith(
                                fontFamily: boldGoogleSansFont,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            height(0.5.h),
                            Text(
                              dmtEController.validateRemitterModel.value.data!.bank3Limit != null && dmtEController.validateRemitterModel.value.data!.bank3Limit!.isNotEmpty
                                  ? '₹ ${dmtEController.validateRemitterModel.value.data!.bank3Limit!.toString()}'
                                  : '₹ 0.0',
                              maxLines: 2,
                              style: TextHelper.size14.copyWith(
                                fontFamily: boldGoogleSansFont,
        ...
        mainBody: Column(
          ...
          children: [
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Get.toNamed(Routes.DMT_E_ADD_RECIPIENT_SCREEN);
                      },
                      child: Container(
            ...
            height(1.h),
            Obx(
              () => dmtEController.recipientList.isEmpty
                  ? Expanded(
                      child: notFoundText(
                  ...
                  : Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: dmtEController.recipientList.length,
                          scrollDirection: Axis.vertical,
                          itemBuilder: (context, index) {
                            RecipientListModel recipientData = dmtEController.recipientList[index];
                            return GestureDetector(
                              onTap: () async {
                                dmtEController.selectedRecipientId.value = recipientData.recipientId.toString();
                                await Get.toNamed(
                                  Routes.DMT_E_TRANSACTION_SCREEN,
                                  arguments: recipientData,
                                );
                                await dmtEController.validateRemitter();
                              },
                              child: customCard(
                                child: Padding(
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () async {
                                                ...
                                                bool result = await dmtEController.verifyAccountV1(
                                                ...
                                                if (result == true) {
                                                  ...
                                                  // Call for fetch updated recipient list
                                                  await dmtEController.getRecipientList(isLoaderShow: false);
                                                  successSnackBar(message: dmtEController.accountVerificationV1Model.value.message!);
                                                }
                                                dismissProgressIndicator();
                                              },
                                              child: Container(
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            Padding(
              ...
              child: InkWell(
                onTap: () async {
                  dmtEController.selectedRecipientId.value = recipientId;
                  if (Get.isSnackbarOpen) {
                    Get.back();
                  }
                  showProgressIndicator();
                  bool result = await dmtEController.removeRecipient(mobileNo: mobileNumber, isLoaderShow: false);
                  if (result == true) {
                    // Call for fetch updated recipient list
                    await dmtEController.getRecipientList(isLoaderShow: false);
                    Get.back();
                    successSnackBar(message: dmtEController.removeRecipientModel.value.message);
                  }
                  dismissProgressIndicator();
                },
                splashColor: ColorsForApp.primaryColorBlue.withOpacity(0.1),
