...
class DmtPBeneficiaryListScreen extends StatefulWidget {
  const DmtPBeneficiaryListScreen({Key? key}) : super(key: key);

  @override
  State<DmtPBeneficiaryListScreen> createState() => _DmtPBeneficiaryListScreenState();
}

class _DmtPBeneficiaryListScreenState extends State<DmtPBeneficiaryListScreen> {
  ...
  Future<void> callAsyncApi() async {
    try {
      await dmtPController.getRecipientList();
      ...
      child: CustomScaffold(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    width(1.w),
                    Text(
                      dmtPController.validateRemitterModel.value.data!.name != null && dmtPController.validateRemitterModel.value.data!.name!.isNotEmpty ? dmtPController.validateRemitterModel.value.data!.name! : '-',
                      style: TextHelper.size13.copyWith(
                ...
                Row(
                  children: [
                    ...
                    width(1.w),
                    Text(
                      dmtPController.validateRemitterModel.value.data!.mobileNo != null && dmtPController.validateRemitterModel.value.data!.mobileNo!.isNotEmpty ? dmtPController.validateRemitterModel.value.data!.mobileNo! : '-',
                      style: TextHelper.size13.copyWith(
                        fontFamily: boldGoogleSansFont,
                        color: ColorsForApp.primaryColor,
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            height(0.5.h),
                            Text(
                              dmtPController.validateRemitterModel.value.data!.bank1Limit != null && dmtPController.validateRemitterModel.value.data!.bank1Limit!.isNotEmpty
                                  ? '₹ ${dmtPController.validateRemitterModel.value.data!.bank1Limit!.toString()}'
                                  : '₹ 0.0',
                              maxLines: 2,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            height(0.5.h),
                            Text(
                              dmtPController.validateRemitterModel.value.data!.bank2Limit != null && dmtPController.validateRemitterModel.value.data!.bank2Limit!.isNotEmpty
                                  ? '₹ ${dmtPController.validateRemitterModel.value.data!.bank2Limit!.toString()}'
                                  : '₹ 0.0',
                              maxLines: 2,
                              style: TextHelper.size14.copyWith(
                                fontFamily: boldGoogleSansFont,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            height(0.5.h),
                            Text(
                              dmtPController.validateRemitterModel.value.data!.bank3Limit != null && dmtPController.validateRemitterModel.value.data!.bank3Limit!.isNotEmpty
                                  ? '₹ ${dmtPController.validateRemitterModel.value.data!.bank3Limit!.toString()}'
                                  : '₹ 0.0',
                              maxLines: 2,
                              style: TextHelper.size14.copyWith(
                                fontFamily: boldGoogleSansFont,
        ...
        mainBody: Column(
          ...
          children: [
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Get.toNamed(Routes.DMT_P_ADD_RECIPIENT_SCREEN);
                      },
                      child: Container(
            ...
            height(1.h),
            Obx(
              () => dmtPController.recipientList.isEmpty
                  ? Expanded(
                      child: notFoundText(
                  ...
                  : Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: dmtPController.recipientList.length,
                          scrollDirection: Axis.vertical,
                          itemBuilder: (context, index) {
                            RecipientListModel recipientData = dmtPController.recipientList[index];
                            return GestureDetector(
                              onTap: () async {
                                dmtPController.selectedRecipientId.value = recipientData.recipientId.toString();
                                await Get.toNamed(
                                  Routes.DMT_P_TRANSACTION_SCREEN,
                                  arguments: recipientData,
                                );
                                await dmtPController.validateRemitter();
                              },
                              child: customCard(
                                child: Padding(
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () async {
                                                ...
                                                bool result = await dmtPController.verifyAccountV1(
                                                  ...
                                                  bankId: recipientData.bankId != null && recipientData.bankId!.isNotEmpty ? recipientData.bankId! : '',
                                                  isLoaderShow: false,
                                                );
                                                if (result == true) {
                                                  // Call for fetch updated balance
                                                  ...
                                                  // Call for fetch updated recipient list
                                                  await dmtPController.getRecipientList(isLoaderShow: false);
                                                  successSnackBar(message: dmtPController.accountVerificationV1Model.value.message);
                                                }
                                                dismissProgressIndicator();
                                              },
                                              child: Container(
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            Padding(
              ...
              child: InkWell(
                onTap: () async {
                  dmtPController.selectedRecipientId.value = recipientId;
                  if (Get.isSnackbarOpen) {
                    Get.back();
                  }
                  showProgressIndicator();
                  bool result = await dmtPController.removeRecipient(mobileNo: mobileNumber, isLoaderShow: false);
                  if (result == true) {
                    // Call for fetch updated recipient list
                    await dmtPController.getRecipientList(isLoaderShow: false);
                    Get.back();
                    successSnackBar(message: dmtPController.removeRecipientModel.value.message);
                  }
                  dismissProgressIndicator();
                },
                splashColor: ColorsForApp.primaryColorBlue.withOpacity(0.1),
