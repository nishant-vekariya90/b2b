...
class DmtBRecipientListScreen extends StatefulWidget {
  const DmtBRecipientListScreen({Key? key}) : super(key: key);

  @override
  State<DmtBRecipientListScreen> createState() => _DmtBRecipientListScreenState();
}

class _DmtBRecipientListScreenState extends State<DmtBRecipientListScreen> {
  ...
  Future<void> callAsyncApi() async {
    try {
      await dmtBController.getRecipientList();
      ...
      child: CustomScaffold(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    width(1.w),
                    Text(
                      dmtBController.validateRemitterModel.value.data!.name != null && dmtBController.validateRemitterModel.value.data!.name!.isNotEmpty ? dmtBController.validateRemitterModel.value.data!.name! : '-',
                      style: TextHelper.size13.copyWith(
                ...
                Row(
                  children: [
                    ...
                    width(1.w),
                    Text(
                      dmtBController.validateRemitterModel.value.data!.mobileNo != null && dmtBController.validateRemitterModel.value.data!.mobileNo!.isNotEmpty ? dmtBController.validateRemitterModel.value.data!.mobileNo! : '-',
                      style: TextHelper.size13.copyWith(
                        fontFamily: boldGoogleSansFont,
                        color: ColorsForApp.primaryColor,
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            height(0.5.h),
                            Text(
                              dmtBController.validateRemitterModel.value.data!.bank1Limit != null && dmtBController.validateRemitterModel.value.data!.bank1Limit!.isNotEmpty
                                  ? '₹ ${dmtBController.validateRemitterModel.value.data!.bank1Limit!.toString()}'
                                  : '₹ 0.0',
                              maxLines: 2,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            height(0.5.h),
                            Text(
                              dmtBController.validateRemitterModel.value.data!.bank2Limit != null && dmtBController.validateRemitterModel.value.data!.bank2Limit!.isNotEmpty
                                  ? '₹ ${dmtBController.validateRemitterModel.value.data!.bank2Limit!.toString()}'
                                  : '₹ 0.0',
                              maxLines: 2,
                              style: TextHelper.size14.copyWith(
                                fontFamily: boldGoogleSansFont,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            height(0.5.h),
                            Text(
                              dmtBController.validateRemitterModel.value.data!.bank3Limit != null && dmtBController.validateRemitterModel.value.data!.bank3Limit!.isNotEmpty
                                  ? '₹ ${dmtBController.validateRemitterModel.value.data!.bank3Limit!.toString()}'
                                  : '₹ 0.0',
                              maxLines: 2,
                              style: TextHelper.size14.copyWith(
                                fontFamily: boldGoogleSansFont,
        ...
        mainBody: Column(
          ...
          children: [
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Get.toNamed(Routes.DMT_B_ADD_RECIPIENT_SCREEN);
                      },
                      child: Container(
            ...
            height(1.h),
            Obx(
              () => dmtBController.recipientList.isEmpty
                  ? Expanded(
                      child: notFoundText(
                  ...
                  : Expanded(
                      child: RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: dmtBController.recipientList.length,
                          scrollDirection: Axis.vertical,
                          itemBuilder: (context, index) {
                            RecipientListModel recipientData = dmtBController.recipientList[index];
                            return GestureDetector(
                              onTap: () async {
                                dmtBController.selectedRecipientId.value = recipientData.recipientId.toString();
                                await Get.toNamed(
                                  Routes.DMT_B_TRANSACTION_SCREEN,
                                  arguments: recipientData,
                                );
                                await dmtBController.validateRemitter();
                              },
                              child: customCard(
                                child: Padding(
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () async {
                                                ...
                                                if (result == true) {
                                                  await dmtBController.validateRemitter(isLoaderShow: false);
                                                  bool result = await dmtBController.getRecipientList(isLoaderShow: false);
                                                  if (result == true) {
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            Padding(
              ...
              child: InkWell(
                onTap: () async {
                  dmtBController.selectedRecipientId.value = recipientId;
                  if (Get.isSnackbarOpen) {
                    Get.back();
                  }
                  showProgressIndicator();
                  bool result = await dmtBController.removeRecipient(mobileNo: mobileNumber, isLoaderShow: false);
                  if (result == true) {
                    // Call for fetch updated recipient list
                    await dmtBController.getRecipientList(isLoaderShow: false);
                    Get.back();
                    successSnackBar(message: dmtBController.removeRecipientModel.value.message);
                  }
                  dismissProgressIndicator();
                },
                splashColor: ColorsForApp.primaryColorBlue.withOpacity(0.1),
