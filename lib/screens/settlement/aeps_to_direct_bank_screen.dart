...
class AepsToDirectBankScreen extends StatefulWidget {
  const AepsToDirectBankScreen({super.key});
  @override
  State<AepsToDirectBankScreen> createState() => _AepsToDirectBankScreenState();
}

class _AepsToDirectBankScreenState extends State<AepsToDirectBankScreen> {
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
      title: 'To Direct Bank Settlement',
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              height(5),
              Text(
                '(To Direct Bank - ${aepsSettlementController.paymentModeController.text.trim()})',
                style: TextHelper.size14,
              ),
            ],
          ),
