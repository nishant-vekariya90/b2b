...
class MiniStatementReceiptScreen extends StatefulWidget {
  const MiniStatementReceiptScreen({super.key});

  @override
  State<MiniStatementReceiptScreen> createState() => _MiniStatementReceiptScreenState();
}

class _MiniStatementReceiptScreenState extends State<MiniStatementReceiptScreen> {
  final ReceiptController receiptController = Get.find();
  MiniStatementModel data = Get.arguments;
  ...
  Future<void> callAsyncApi() async {
    try {
      ...
      receiptResult.value = await receiptController.getReceiptForMiniStatement(
        params: data.toJson(),
        isLoaderShow: false,
      );
