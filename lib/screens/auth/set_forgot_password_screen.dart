...
class SetForgotPasswordScreen extends StatefulWidget {
  const SetForgotPasswordScreen({super.key});

  @override
  State<SetForgotPasswordScreen> createState() => _SetForgotPasswordScreenState();
}

class _SetForgotPasswordScreenState extends State<SetForgotPasswordScreen> {
              ...
              CommonButton(
                onPressed: () async {
                  if (setPasswordFormKey.currentState!.validate()) {
                    bool result = await authController.setForgotPasswordAPI();
                    if (result == true) {
