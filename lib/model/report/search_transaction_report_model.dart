...
class SearchTransactionReportModel {
  List<SearchTransactionData>? data;
  String? message;
  int? statusCode;

  SearchTransactionReportModel({this.data, this.message, this.statusCode});

  SearchTransactionReportModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <SearchTransactionData>[];
      json['data'].forEach((v) {
        data!.add(SearchTransactionData.fromJson(v));
      });
    }
...
class SearchTransactionData {
  ...
  SearchTransactionData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    updatedMethod = json['updatedMethod'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['updatedMethod'] = updatedMethod;
