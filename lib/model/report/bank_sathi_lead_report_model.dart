class BankSathiLeadReportModel {
  List<BankSathiLeadReportData>? data;
  Pagination? pagination;
  String? message;
  int? statusCode;
  int? status;

  BankSathiLeadReportModel({this.data, this.pagination, this.message, this.statusCode, this.status});

  BankSathiLeadReportModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <BankSathiLeadReportData>[];
      json['data'].forEach((v) {
        data!.add(BankSathiLeadReportData.fromJson(v));
      });
    }
...
class BankSathiLeadReportData {
  ...
  BankSathiLeadReportData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
