...
class AepsWalletPassbookModel {
  int? statusCode;
  String? message;
  List<AepsPassbookWalletData>? data;
  Pagination? pagination;

  AepsWalletPassbookModel({
    this.statusCode,
    this.message,
    this.data,
    this.pagination,
  ...
  AepsWalletPassbookModel.fromJson(Map<String, dynamic> json) {
    statusCode = json['statusCode'];
    message = json['message'];
    if (json['data'] != null) {
      data = <AepsPassbookWalletData>[];
      json['data'].forEach((v) {
        data!.add(AepsPassbookWalletData.fromJson(v));
      });
    }
...
class AepsPassbookWalletData {
  ...
  AepsPassbookWalletData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    uqID = json['uqID'];
    userID = json['userID'];
