...
class BankWithdrawalReportModel {
  List<BankWithdrawalReportData>? data;
  Pagination? pagination;
  String? message;
  int? status;

  BankWithdrawalReportModel(
      {this.data, this.pagination, this.message, this.status});

  BankWithdrawalReportModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <BankWithdrawalReportData>[];
      json['data'].forEach((v) {
        data!.add(BankWithdrawalReportData.fromJson(v));
      });
    }
...
class BankWithdrawalReportData {
  int? id;
  int? tenantID;
  String? tenantName;
  int? userID;
  ...
  BankWithdrawalReportData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
